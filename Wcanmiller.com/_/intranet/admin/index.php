...
// show userlog page
if ($show == 999) {
	echo '<div class="title">User Log</div>';
	echo '<p>To save the file, right-click and choose "Save link as..." or "Save target as...".';
	echo '<p><b><a href="userlog.csv">userlog.csv</a></b></p>';
}
else {
// set page number
...
// Print Files Info
	...
	$dir = (($show == 1 || $show == 2 || $show == 10 || $show == 11 || $show == 12 || $show == 13 || $show == 14 || $show == 15 || $show == 16 || $show == 23) ? '../bm/uploads/' : '../sh/uploads/');
