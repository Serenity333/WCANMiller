	...
	$table = <<<WORK
		<table class="upload">
			...
			<tr><td>
				...
				<td><a href="../management/">Cancel and return to the main page.</a></td>
			</tr>
		</table>
WORK;
...
if ($_POST['submit'] == 'Confirm Delete') {
	...
	$row = mysql_fetch_assoc($results);
	extract($row);
	if ($udirectory == 24) { $dir ='uploads/'; }
	$deletedFile = $dir . $fileName;
	
	unlink($deletedFile);
	mysql_query("DELETE FROM uploadedDocs WHERE udID = $thisrow") or die(mysql_error($db));

	echo '<p>The file record has been deleted.</p><p><a href = "../management/">Return to the main page.</a></p>';
...
// check title
	...
	echo '<p>The record has been updated.</p><p><a href = "../management/">Return to the main page.</a></p>';
...
//insert information into image table
   $query = 'INSERT INTO uploadedDocs
	...
	echo '<p>The new Record was created.</p><p><a href="maddnewfileform.php">Add another file.</a></p><p><a href = "../management/">Return to the main page.</a></p>';
}
?>
</div><!-- end admin -->
</div><!-- end container -->
